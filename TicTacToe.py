...
Fixed player symbol bug, added main safety, and reduced training rounds
"""
...
class State:
    ...
    def play2(self):
        while not self.isEnd:
            ...
            win = self.winner()
            if win is not None:
                print(f"{self.p1.name} wins!" if win == 1 else "tie!")
                self.reset()
                break
            ...
            win = self.winner()
            if win is not None:
                print(f"{self.p2.name} wins!" if win == -1 else "tie!")
                self.reset()
                break
...
if __name__ == "__main__":
    ...
    st = State(p1, p2)
    print("training...")
    st.play(10000)  # REDUCED for faster execution
    ...
    while c == "y":
        st.play2()
        c = input("If you wish to continue press y else n: ")
